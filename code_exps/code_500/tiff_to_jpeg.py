...
def image_to_jpeg(path: Path, suffix: str, image: np.ndarray):
    ...
    try:
        ...
        output_dir = Path('C:/University of Limerick/AI_ML/code_exps/code_500/input/prostate-cancer-grade-assessment/train_images_jpeg')  # Define the output directory for JPEG images
