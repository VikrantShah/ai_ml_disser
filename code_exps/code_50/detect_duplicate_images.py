...
print("Saved the DataFrame to CSV file: C:/University of Limerick/AI_ML/code_exps/code_50/input/duplicate_imgids_imghash_thres_090.csv")  # Debugging statement
